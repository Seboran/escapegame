...
#==============================================================================
#Fonctions de simulation des élèves dans la pièce
#==============================================================================
def Salle_233_235_full_occupation(x0,y0,largeur_porte,espace_x_porte,espace_x,espace_y,largeur_bureau,longueur_bureau,espace_agent_table,sigma,epsilon):
    eleves = []
    ...
    #ajout des élèves dans la partie gauche de la salle (on place un agent à chaque place)
        for i in range(3): 
            x = x0+0.1+largeur_porte+espace_x_porte + largeur_bureau + i*(largeur_bureau + espace_x)
        ...
        for i in range(3):
            ...
            y =  y0 + espace_y + i*(largeur_bureau + espace_y) +largeur_bureau
...
def Salle_233_235_left_occupation(x0,y0,largeur_porte,espace_x_porte,espace_x,espace_y,largeur_bureau,longueur_bureau,espace_agent_table,sigma,epsilon):
    eleves = []
    for j in [0.25,0.75]:#A chaque bureau, on peut mettre un maximum de 2 élèves
    #ajout des élèves dans la partie gauche de la salle (on place un agent à chaque place)
        for i in range(3): 
...
def Salle_233_235_right_occupation(x0,y0,largeur_porte,espace_x_porte,espace_x,espace_y,largeur_bureau,longueur_bureau,espace_agent_table,sigma,epsilon):
    eleves = []
    for j in [0.25,0.75]:#A chaque bureau, on peut mettre un maximum de 2 élèves
        #ajout des élèves dans la partie droite de la salle (on place un agent à chaque place)
        for i in range(3):
